				...
				<li class="nav-item">
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							...
							<a class="dropdown-item" href="/user/getAllMembers">View Members Added By Me</a>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <sec:authorize
                                ...
                                <a  class="dropdown-item" href="/matrimony/viewActiveProfiles">View All Active Wed Profiles</a>
                            </sec:authorize>
                        </div>
                    </div>
                </li>
